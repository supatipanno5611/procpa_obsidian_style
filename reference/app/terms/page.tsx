      ...
      <div className="mx-auto max-w-5xl px-6 py-16">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8 text-sm leading-relaxed text-muted-foreground">
          <section>
            ...
            <p>
              본 약관은 PROCPA(이하 &quot;사이트&quot;)가 제공하는 웹사이트
              서비스의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을
              목적으로 합니다.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              사이트에 게시된 모든 콘텐츠(글, 이미지, 코드 등)의 저작권은
              PROCPA에 있으며, 무단 복제·배포·전송을 금지합니다.
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li>
                개인적·비상업적 목적의 학습 용도로는 자유롭게 활용할 수
                있습니다.
              </li>
              <li>
                출처를 명시한 경우 일부 인용이 가능합니다.
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              사이트의 콘텐츠는 정보 제공 목적으로 작성되었으며, 전문적인
              회계·세무·법률 자문을 대체하지 않습니다. 콘텐츠의 활용으로 인한
